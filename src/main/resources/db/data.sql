...
values ('ssar', '$2a$10$jCc14VVOCA3yLD.HvP92ee0wdQ.8jxPKp8sSK.aGooNbZI4E8ZTOC', 'ssar@nate.com', now());
insert into user_tb(username, password, email, created_at)
values ('cos', '$2a$10$jCc14VVOCA3yLD.HvP92ee0wdQ.8jxPKp8sSK.aGooNbZI4E8ZTOC', 'cos@nate.com', now());
insert into user_tb(username, password, email, created_at)
values ('love', '$2a$10$jCc14VVOCA3yLD.HvP92ee0wdQ.8jxPKp8sSK.aGooNbZI4E8ZTOC', 'love@nate.com', now());
